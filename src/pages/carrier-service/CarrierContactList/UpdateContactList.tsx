...
const UpdateContactList: React.FC<UpdateContactListProps> = ({ customerId }) => {
  ...
  const { data: contacts = [], isLoading, isError, refetch } = useQuery<Contact[]>({ 
    ...
    queryFn: async () => {
      ...
      const response = await apiService.ContactCarrier.getAllContactPerson(customerId);
  ...
  const addContactMutation = useMutation({
    mutationFn: (contact: any) => apiService.ContactCarrier.addContactPerson(customerId, contact),
    onSuccess: () => {
  ...
  const updateContactMutation = useMutation({
    mutationFn: (contact: Contact) => apiService.ContactCarrier.updateContactPerson(contact._id!, contact),
    onSuccess: () => {
  ...
  const deleteContactMutation = useMutation({
    mutationFn: (contactId: string) => apiService.ContactCarrier.deleteContactPerson(contactId),
    onSuccess: () => {
