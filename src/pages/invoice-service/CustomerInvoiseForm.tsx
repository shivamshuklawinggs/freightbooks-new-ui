...
import CustomerForm from '@/pages/customer-service/acoount-customers/components/CustomerForm';
...
const CustomerInvoiceForm: React.FC<CustomerInvoiceFormProps> = ({ onSubmit, initialData,loading }) => {
  ...
  //     setValue("taxArray", response.data);
      ...
      <form >
        {loading ? (
          ...
          <Grid container spacing={3}>
            ...
            <ErrorHandlerAlert error={Object.keys(errors).length > 0 ? errors : null} excludedFields={["carrierData", "customerdata", "carrierid", "loadid", "loadAmount", "customerid"]} />
          <Grid item xs={12}>
