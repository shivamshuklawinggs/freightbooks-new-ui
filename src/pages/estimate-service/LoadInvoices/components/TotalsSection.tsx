  ...
  return (
   ...
   {/* Recieved Payment */}
 
      {
        ...
        >
          <Typography fontWeight={700} color='primary' sx={{display:'flex',alignItems:'center'}} > Payment On {formatDate(payment.paymentDate)} <Edit fontSize='small' onClick={()=>navigate(`${paths.recievedpayment}/${payment._id}`)}/></Typography>
