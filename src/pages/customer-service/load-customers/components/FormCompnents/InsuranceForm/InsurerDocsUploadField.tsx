...
import { CUSTOMER_INSURANCE_DOCUMENTS_UPLOAD_URL } from '@/config';
                  ...
                  >
                    <ListItemAvatar>
                      {getFileType(item as any).startsWith('image') ? (
                        <Avatar variant="square" src={getFilePreview(item as any,CUSTOMER_INSURANCE_DOCUMENTS_UPLOAD_URL) || undefined} />
                      ) : (
                        <Avatar>
                          <InsertDriveFile />
                        </Avatar>
