...
import { ICustomer ,IFile } from '@/types';
import { CUSTOMER_DOCUMENTS_UPLOAD_URL } from '@/config';
                  ...
                  >
                    <ListItemAvatar>
                      {getFileType(item as any).startsWith('image') ? (
                        <Avatar variant="square" src={getFilePreview(item as any,CUSTOMER_DOCUMENTS_UPLOAD_URL) || undefined} />
                      ) : (
                        <Avatar>
                          <InsertDriveFile />
                        </Avatar>
