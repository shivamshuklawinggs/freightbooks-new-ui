...
interface CarrierFiltersProps {
  ...
  onFiltersChange: (filters: CarrierFiltersType) => void;
  onClearFilters: () => void;
}
const CarrierFilters: React.FC<CarrierFiltersProps> = ({
  ...
  const updateFilter = (key: keyof CarrierFiltersType, value: any) => {
    onFiltersChange({
      ...filters,
      [key]: value,
    });
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    onChange={(e) => updateFilter('hasDrivers', e.target.checked)}
                  />
                }
                label="Has Drivers"
              />
